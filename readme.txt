...
[日本語の説明](http://stepxstep.net/?page_id=2804  "Documentation in Japanese")
...
1. Upload the entire `boilerplate-statement-register` folder to the `/wp-content/plugins/` directory.
